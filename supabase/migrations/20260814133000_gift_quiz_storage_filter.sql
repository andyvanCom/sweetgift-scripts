-- Known fresh-fruit and chocolate-strawberry categories are day-of gifts.
-- Keep uncertain products as soft-ranked alternatives, but never return these
-- explicit perishable categories for next-day or multi-day storage answers.
